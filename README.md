...
See [the orchestration workflow](docs/orchestration/workflow.md) for the complete
...
Executable agent definitions live in [`.codex/agents`](.codex/agents). Shared
runtime settings live in [`.codex/config.toml`](.codex/config.toml).
